...
import { CiMail, CiLaptop, CiMonitor } from "react-icons/ci";
  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section className="max-w-4xl mx-auto text-center">
        <Link
          href="/contact"
          className="inline-flex items-center gap-2 px-8 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition"
        >
          <CiMail size={24} />
          Contact Me
        </Link>
