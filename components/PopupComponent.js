...
export default function PopupComponent() {
  ...
  if (!hasMounted) return null; // ⛔️ Avoid SSR mismatch
  ...
  return (
    ...
    >
      {close => (
        <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg text-center relative">
          <button
            className="absolute top-2 right-4 text-gray-500 dark:text-gray-300 text-2xl"
            onClick={close}
          >
            ×
          </button>
